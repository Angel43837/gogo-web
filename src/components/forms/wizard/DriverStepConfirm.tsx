...
import { ClipboardCheck, Loader2, Pencil, ShieldCheck } from "lucide-react";
...
import type { DriverStep1, DriverStep2, DriverStep3 } from "@/lib/driverRegistration";
import { driverTermsSchema } from "@/lib/driverRegistration";
import type { PickedImage } from "@/lib/restaurantRegistration";

type Terms = { acceptTerms: true; acceptSafety: true };
